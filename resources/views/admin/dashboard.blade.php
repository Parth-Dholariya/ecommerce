...
@section('main-container')
    ...
    {{-- <div class="media-body text-left">
                                  <h4 class="font-large-2 white">12,515</h4>
        ...
        <i class="la la-ellipsis-v font-medium-3"></i>
          ...
          <div class="card-content">
              <div class="card-body chat-application">
                  ...
                  <img src="{{asset('app-assets/images/portrait/small/avatar-s-19.jpg')}}" alt="avatar" />
                </a>
                              </div>
                              <div class="chat-body">
                  ...
                  <img src="{{asset('app-assets/images/portrait/small/avatar-s-15.jpg')}}" alt="avatar" />
                </a>
                              </div>
                              <div class="chat-body">
                                  <div class="chat-content">
