    ...
    <div class="product_image_area section_padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section_tittle s_product_text">
                ...
                <div class="row s_product_inner justify-content-between">
                    <div class="col-lg-7 col-xl-7">
                        <div class="product_slider_img">
                            <div id="vertical">
                                <div data-thumb="{{ asset('image') }}/{{ $products['gallery'] }}">
                                    <img src="{{ asset('image') }}/{{ $products['gallery'] }}" />
                                </div>
                                <div data-thumb="{{ asset('img/b1.jpg') }}">
                                    <img src="{{ asset('img/b1.jpg') }}" />
                                </div>
                                <div data-thumb="{{ asset('img/b2.jpg') }}">
                                    <img src="{{ asset('img/b2.jpg') }}" />
                                </div>
                                <div data-thumb="{{ asset('img/b1.jpg') }}">
                                    <img src="{{ asset('img/b1.jpg') }}" />
                                </div>
                    ...
                    <div class="col-lg-5 col-xl-4">
                        <div class="s_product_text">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    <a href="#"> <span>Availibility</span> : {!!$stockLevel!!}</a>
                                </li>
                            </ul>
                            <p>
      ...
      <div class="row s_product_inner justify-content-between">
        <div class="col-lg-7 col-xl-7">
              <div data-thumb="img/product/single-product/product_1.png')}}">
                <img src="{{asset('img')}}/{{$products['gallery']}}" />
              </div>
        </div>
        <div class="col-lg-5 col-xl-4">
          <div class="s_product_text">
