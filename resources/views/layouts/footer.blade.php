  ...
  <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-xl-block"><a class="customizer-close"
          href="#"><i class="ft-x font-medium-3"></i></a><a class="customizer-toggle bg-primary box-shadow-3" href="#"
          id="customizer-toggle-setting"><i class="ft-settings font-medium-3 spinner white"></i></a>
  ...
  <div class="bg-white sidebar-color-option" data-sidebar="menu-light" title="white"></div>
          ...
          <div class="cz-bg-image row">
              <div class="col mb-3">
                  <img src="{{ asset('app-assets/images/backgrounds/04.jpg') }}" class="rounded sidiebar-bg-img"
                      width="50" height="100" alt="background image">
              </div>
              <div class="col mb-3">
                  <img src="{{ asset('app-assets/images/backgrounds/01.jpg') }}" class="rounded sidiebar-bg-img"
                      width="50" height="100" alt="background image">
              </div>
              <div class="col mb-3">
                  <img src="{{ asset('app-assets/images/backgrounds/02.jpg') }}" class="rounded sidiebar-bg-img"
                      width="50" height="100" alt="background image">
              </div>
              <div class="col mb-3">
                  <img src="{{ asset('app-assets/images/backgrounds/05.jpg') }}" class="rounded sidiebar-bg-img"
                      width="50" height="100" alt="background image">
              </div>
          </div>
  ...
  <script>
    $(document).ready(function() {
        $('.editbtn').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ URL('edit-status') }}/" + stud_id,

                success: function(response) {
                    // console.log(response.student.name);
                    $('#tracking_no').val(response.order.tracking_no);
                    $('#order_status').val(response.order.order_status);
                    $('#stud_id').val(stud_id);
                }
            });
        });
...
<script src="{{ asset('app-assets/js/bootstrap.bundle.min.js') }}"></script>
  ...
  <!-- Mirrored from themeselection.com/demo/chameleon-admin-template/html/ltr/vertical-menu-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 03:50:00 GMT -->
</html>
